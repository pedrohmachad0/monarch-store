...
const categories = [
  { name: 'Old Money', label: 'Clássicos refinados', slug: 'old-money', image: media.categories.oldMoney },
  { name: 'Streetwear', label: 'Atitude contemporânea', slug: 'streetwear', image: media.categories.streetwear },
  { name: 'Essentials', label: 'O essencial bem feito', slug: 'essentials', image: media.categories.essentials },
];
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#141414]">
        ...
        <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-[1440px] lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="relative min-h-[560px] overflow-hidden lg:min-h-0">
            <img src={media.hero} alt="Homem usando look masculino sofisticado em tons neutros" className="absolute inset-0 h-full w-full object-cover object-center grayscale-[15%] transition duration-700 hover:scale-[1.02]" />
