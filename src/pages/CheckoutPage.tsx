...
import { cartItemToOrderItem } from '../types/order';
import { formatBRL } from '../utils/currency';

type CheckoutFields = OrderAddress;
type FieldErrors = Partial<Record<keyof CheckoutFields, string>>;

const initialFields: CheckoutFields = { name: '', email: '', phone: '', cep: '', address: '', number: '', complement: '', neighborhood: '', city: '', state: '' };
...
export function CheckoutPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (processing || !validateFields()) return;
    if (!user) {
      setSubmitError('Entre na sua conta para registrar o pedido. Seu carrinho será preservado.');
